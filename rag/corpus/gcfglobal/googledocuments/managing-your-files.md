...
> Source: https://edu.gcfglobal.org/en/googledocuments/managing-your-files/1/

## Lesson 5: Managing Your Files

/en/googledocuments/uploading-files-to-google-drive/content/
...
- Choose the desired filter. In our example, we'll select Text documents.
...
- Open our example file. Make sure you're signed in to Google, then click File > Make a copy. For now, do not rename the copy.

- Open Google Drive, create a folder, and name it Practice Documents.

- Locate our example file in your drive.

- Add our example file to the folder you created in step 2.

- Open the folder and preview the example file.

- Close the preview.

- When you're finished, your screen should look something like this:

/en/googledocuments/converting-and-printing-docs/content/