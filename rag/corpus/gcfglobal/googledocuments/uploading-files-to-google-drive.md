...
> Source: https://edu.gcfglobal.org/en/googledocuments/uploading-files-to-google-drive/1/

## Lesson 4: Uploading Files to Google Drive

/en/googledocuments/creating-google-docs/content/
...
- If you go back to your Google Drive, you'll see that there are now two copies of the file: the original file and the new version in Google Docs format.
...
- If you used our example file, your screen should look something like this:

/en/googledocuments/managing-your-files/content/