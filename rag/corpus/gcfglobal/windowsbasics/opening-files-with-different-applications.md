...
> Source: https://edu.gcfglobal.org/en/windowsbasics/opening-files-with-different-applications/1/
...
- From the desktop, right-click the desired file, select Open with, and click Choose another app from the menu that appears.

- Select the desired application. If you don't see the one you want, click More apps or Look for an app in the Store  to look for other applications. In this example, we want to open the file in Windows Photo Viewer. Then check off Always use this app to open .jpg files and click OK.

- The file will open in the new application. The next time you double-click a file of that type, it will open in the new default application.
